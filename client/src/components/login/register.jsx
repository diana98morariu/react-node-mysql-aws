        ...
        <div className="register-base-container">
            ...
            <div className="content">
                ...
                <div className="register-form">
                    ...
                    <div className="form-group">
                        <label htmlFor="repeatPassword">Repeat Password (Min. 3 char.)</label>
                        <input 
                        type="password" 
                        name="repeatPassword" 
            ...
            <div className="footer">
                <button type="button" onClick={requestRegister} className="btn">Register</button>
            </div>
            
            <div className="link-text">
              <div>Have an account?</div>
              <div><NavLink to="/login">Login now!</NavLink></div>
            </div>
        </div>
    )
